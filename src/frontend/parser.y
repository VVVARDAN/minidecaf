...
%nterm<mind::ast::Statement*> Stmt  ReturnStmt ExprStmt IfStmt  CompStmt WhileStmt DoWhileStmt ForStmt
...
ForStmt : FOR LPAREN Expr SEMICOLON Expr SEMICOLON Expr RPAREN Stmt
            ...
            | 
            FOR LPAREN VarDecl SEMICOLON Expr SEMICOLON Expr RPAREN Stmt
                { $$ = new ast::ForStmt($3, $5, $7, $9, POS(@1)); }
              |
            FOR LPAREN VarDecl SEMICOLON Expr SEMICOLON RPAREN Stmt
                { $$ = new ast::ForStmt($3, $5, NULL, $8, POS(@1)); }
              |
            FOR LPAREN SEMICOLON SEMICOLON RPAREN Stmt
                { 
                  $$ = new ast::ForStmt($6, POS(@1)); }
              //|
            //FOR LPAREN SEMICOLON SEMICOLON RPAREN SEMICOLON
              //  { $$ = new ast::ForStmt(NULL, POS(@1)); }
            ;
